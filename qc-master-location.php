...
<?php
    ...
    if($op == 'delete'){
        $id         = $_GET['id'];
        $sql1       = "DELETE FROM master_location where id = '$id'";
    ...
    if ($op == 'edit') {
        $id             = $_GET['id'];
        $sql1           = "SELECT * FROM master_location where id = '$id'";
        $q1             = mysqli_query($conn, $sql1);
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($location) {
            //Update Data
            if ($op == 'edit') { 
                $sql1       = "UPDATE master_location SET location='$location' where id = '$id'";
                $q1         = mysqli_query($conn, $sql1);

                if ($q1) {
                    $succeed = "Update success";
                    header("refresh:4;url=qc-master-location.php");
                } else {
                    $error  = "Update error";
                }
            }
            //Inster Data
                ...
                $sql1   = "INSERT INTO master_location values ('', '$location')";
                $q1     = mysqli_query($conn, $sql1);
									...
									<div class="px-2 pt-2">
										...
										<div id="QC" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
											<ul>
                                                ...
                                                <li class="dropdown-item">
													<a href="qc-master-location.php" role="button" class="btn btn-nav-item w-100 text-start rounded text-black btn-sm active">Master Location</a>
												</li>
											</ul>
										 </div>
									</div>
                                    ...
                                    <form action="" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <!-- Input Item -->
                                                <div class="mb-1 row">
                                                    <label for="part_name" class="col-sm-12 col-form-label">Location</label>
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 d-flex justify-content-end mt-2">
                                                <input type="submit" id="submit" name="submit" value="Submit" class="btn btn-submit col-md-3 col-lg-3 col-xl-2" />
                                            </div>
                                            <!-- End Submit Button -->
                                        </div>
                            ...
                            <div class="container shadow px-4 py-4">
                                ...
                                <div class="table-responsive-lg">                                
                                    <table id="master_problem_table" class=" table-sm display nowrap table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql2   = "SELECT * FROM master_location ORDER BY location ASC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td scope="row">
                                                        <a href="qc-master-location.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-sm btn-warning">Edit</button></a>
                                                        <a href="qc-master-location.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete the data?')"><button type="button" class="btn btn-sm btn-danger">Delete</button></a>            
                                                    </td>
