...
<?php
    ...
    if($op == 'delete'){
        $id         = $_GET['id'];
        $sql1       = "DELETE FROM master_problem where id = '$id'";
    ...
    if ($op == 'edit') {
        $id             = $_GET['id'];
        $sql1           = "SELECT * FROM master_problem where id = '$id'";
        $q1             = mysqli_query($conn, $sql1);
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($problem && $category) {
            //Update Data
            if ($op == 'edit') { 
                $sql1       = "UPDATE master_problem SET problem='$problem', category='$category' where id = '$id'";
                $q1         = mysqli_query($conn, $sql1);

                if ($q1) {
                    $succeed = "Update success";
                    header("refresh:4;url=qc-master-problem.php");
                } else {
                    $error  = "Update error";
                }
            }
            //Inster Data
                ...
                $sql1   = "INSERT INTO master_problem values ('', '$problem', '$category')";
                $q1     = mysqli_query($conn, $sql1);
...
<body class="bg-light bg-light" >
									...
									<div class="px-2 pt-2">
										...
										<div id="QC" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
											<ul>
                                                ...
                                                <li class="dropdown-item">
													<a href="qc-master-problem.php" role="button" class="btn btn-nav-item w-100 text-start rounded text-black btn-sm active">Master Problem</a>
												</li>
                                                <li class="dropdown-item">
                                    ...
                                    <form action="" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <!-- Input Item -->
                                                <div class="mb-1 row">
                                                    <label for="part_name" class="col-sm-12 col-form-label">Problem</label>
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <!-- Input Item -->
                                                <div class="mb-1 row">
                                                    <label for="part_name" class="col-sm-12 col-form-label">Category</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control form-control-sm" id="category" name="category" value="<?php echo $category ?>">
                                                    </div>
                                                </div>
                                                <!-- End Input Item -->
                                            ...
                                            <div class="col-sm-12 d-flex justify-content-end mt-2">
                                                <input type="submit" id="submit" name="submit" value="Submit" class="btn btn-submit col-md-2 col-lg-2 col-xl-2" />
                                            </div>
                                            <!-- End Submit Button -->
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="container shadow px-4 py-4">
                                ...
                                <div class="table-responsive-lg">                                
                                    <table id="master_problem_table" class="table table-sm display nowrap table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col"></th>
                                                <th scope="col">#</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sql2   = "SELECT * FROM master_problem ORDER BY category ASC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td scope="row">
                                                        <a href="qc-master-problem.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-sm btn-warning">Edit</button></a>
                                                        <a href="qc-master-problem.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete the data?')"><button type="button" class="btn btn-sm btn-danger">Delete</button></a>            
                                                    </td>
    ...
    $('#master_problem_table').DataTable({
        dom: 'Blfrtip',
        buttons: [      
                {
                    extend: 'excelHtml5',
